...
- List patterns: `references/list-patterns.md` — Use for ForEach identity, stable IDs, and list performance.
- Image optimization: `references/image-optimization.md` — Use for AsyncImage, downsampling, and image performance.
- Text formatting: `references/text-formatting.md` — Use for modern Text formatting, localization, and string operations.
- Modern APIs: `references/modern-apis.md` — Use for deprecated API replacements and modern SwiftUI patterns.
