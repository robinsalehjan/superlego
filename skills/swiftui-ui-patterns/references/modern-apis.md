...
**For iOS 18 and later, prefer the `Tab` API over `tabItem()` to access modern tab features.**
...
**Always include text labels with button images for accessibility.**
...
// Acceptable - with accessibility label
Button {
    performAction()
} label: {
